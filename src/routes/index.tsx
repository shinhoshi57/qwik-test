  ...
  <>
    {data.affirmations.length > 0 ? (
      ...
      <>
        ...
        <p class="px-4 py-2 mt-5 rounded border border-white border-solid
        bg-white text-slate-900 hover:bg-slate-300 cursor-pointer duration-200" onClick$={() => { data.openModal = true }}>Add an affirmation</p>
      </>
    )}
